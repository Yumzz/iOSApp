...
//  YumzzClip
//
//  Created by Rohan Tyagi on 1/27/22.
...
//                    self.button.isEnabled = true
                case .connecting,
                     .created:
                    let host = UIHostingController(rootView: PrintUI())
...
extension PrintViewController: MQTTSessionManagerDelegate, MQTTSessionDelegate {
...
struct PrintConnection: UIViewControllerRepresentable {
    var dishes: [DishFB]
    ...
    func makeUIViewController(context: UIViewControllerRepresentableContext<PrintConnection>) -> PrintViewController {
//            code
        print("letsagoo")
        let connection = PrintViewController()
...
//                print("yessss: \(self.order.dishChoice[d])
        ...
        func updateUIViewController(_ uiViewController: PrintViewController, context: UIViewControllerRepresentableContext<PrintConnection>) {
//            code
            print("WE HERE BOII")
        }
}
