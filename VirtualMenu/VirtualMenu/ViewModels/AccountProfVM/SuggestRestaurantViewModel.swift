//
//  SuggestRestaurantViewModel.swift
//  VirtualMenu
//
...
class SuggestRestaurantViewModel: ObservableObject{
    ...
    func sendResponse(email: String, messageBody: String, name: String, disp: DispatchGroup){
        disp.enter()
        let results = self.suggestRestaurantButton(email: email, messageBody: messageBody, name: name)
